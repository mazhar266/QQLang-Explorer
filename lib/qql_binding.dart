...
//
// VENDORED, do not edit here. Upstream is `bindings/dart/qql.dart` in the
// QQ Lang repository; that package keeps the file at its root rather than in
// `lib/`, so it cannot be consumed as a path dependency. Re-copy it after
// upstream changes:
//
//   cp "$QQL_HOME/bindings/dart/qql.dart" lib/qql_binding.dart
//
